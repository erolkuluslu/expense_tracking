// ignore_for_file: avoid_print, prefer_int_literals, strict_raw_type
...
class CurrencyRepository {
  ...
  double calculateCrossRate(
      Map<String, dynamic> rates, String fromCurrency, String toCurrency) {
    ...
    if (!_supportedCurrencies.contains(normalizedFrom) ||
      ...
      print(
          'Warning: Unsupported currency conversion $fromCurrency -> $toCurrency');
      return 1.0;
    }
    ...
    if (toRate == null || fromRate == null) {
      print(
          'Warning: Missing rate for conversion $fromCurrency -> $toCurrency');
      return 1.0;
    }
